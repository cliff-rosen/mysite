...
CREATE TABLE IF NOT EXISTS `conversation` (
  ...
  `conversation_text` text CHARACTER SET utf16 COLLATE utf16_unicode_ci NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=21266 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=46056 DEFAULT CHARSET=latin1;
